...
export default function ContactRow() {
  return (
    <div className="flex flex-col gap-2 sm:flex-row" role="group" aria-label="Contact options">
      ...
      {/* Opens the LeadNudge WhatsApp widget (its script intercepts this
          hash), so the click is captured as a lead instead of a raw wa.me
          handoff. Same-tab href on purpose: the widget preventDefaults it. */}
      <a href="#leadnudge-whatsapp" className={itemClass}>
